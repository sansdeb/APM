                      ...
                      <button type="button"
                        ...
                        onClick={async () => {
                          try {
                            ...
                            const res   = await fetch(`${api.defaults.baseURL}/api/assets/documents/${doc.id}/view`, { headers: { Authorization: `Bearer ${token}` } });
              ...
              <div style={{ ...S.uploadBox, background: '#f0f4ff', border: '1.5px solid #c2cbe0', justifyContent: 'space-between' }}>
                ...
                <button type="button"
                  ...
                  onClick={async () => {
                    try {
                      const token = localStorage.getItem('token');
                      const res   = await fetch(`${api.defaults.baseURL}/api/assets/documents/${faDocUploaded.id}/view`, { headers: { Authorization: `Bearer ${token}` } });
